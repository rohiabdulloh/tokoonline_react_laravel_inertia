...
/***/ "./resources/js/Pages/Produk/Edit.js":
/*!*******************************************!*\
  !*** ./resources/js/Pages/Produk/Edit.js ***!
  \*******************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function (props) {
  var data = props.produk; //masukan deskripsi produk ke react-draft-wysiwyg

  var deskripsi = draft_js__WEBPACK_IMPORTED_MODULE_15__["EditorState"].createWithContent(draft_js__WEBPACK_IMPORTED_MODULE_15__["ContentState"].createFromBlockArray(Object(draft_js__WEBPACK_IMPORTED_MODULE_15__["convertFromHTML"])(data.deskripsi_produk))); //state untuk react-draft-wysiwyg

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(deskripsi),
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({
    ...
    harga: data.harga || "",
    foto: "",
    url_foto: "/images/" + data.foto || false,
    berat: data.berat || "",
    stok: data.stok || 0
  }),
  ...
  function handleSubmit(e) {
    ...
    _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_2__["Inertia"].post(route('produk.update', data.id), formdata);
  }
